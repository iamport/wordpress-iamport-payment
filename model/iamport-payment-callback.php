  ...
  class IamportPaymentCallback {
    ...
    public function handle_callback()
    {
      ...
      if ( $iamport_result->success ) {
        ...
        $old_status = $iamport_order->get_order_status(true);
        ...
        if ( $payment_data->status == 'paid' ) {
          ...
          //가상계좌-입금일 때만 명시적으로 fire hook
          if ($payment_data->pay_method == 'vbank') {
          	do_action('iamport_button_order_status_changed', "awaiting-vbank", $iamport_order->get_order_status(true), $iamport_order, $payment_data);
          }
          ...
          if ($old_status == 'paid') {
            do_action('iamport_button_order_status_changed', $old_status, $iamport_order->get_order_status(true), $iamport_order, $payment_data);
          }
        }
