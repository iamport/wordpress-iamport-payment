...
if ( !class_exists('IamportPaymentButton') ) {
	...
	class IamportPaymentButton {
		...
		public function enqueue_inline_script() {
			/**
       * [v1.1.18]
       * DAUM 주소 API에서 유효하지 않은 쿼리 스트링이 넘어올 경우 BLOCK하기 때문에 version 정보를 null로 설정
       * https://postcode.map.daum.net/guide#usage
       */
      wp_register_script('daum-postcode-for-https', 'https://t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js', array(), null, false);
